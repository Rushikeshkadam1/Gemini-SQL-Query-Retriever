...
# installed.
TCL_PREFIX='C:/Users/Admin/Desktop/VS code/text to SQL LLM app along with quering SQL database/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/Users/Admin/Desktop/VS code/text to SQL LLM app along with quering SQL database/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/Users/Admin/Desktop/VS code/text to SQL LLM app along with quering SQL database/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/Users/Admin/Desktop/VS code/text to SQL LLM app along with quering SQL database/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/Users/Admin/Desktop/VS code/text to SQL LLM app along with quering SQL database/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/Users/Admin/Desktop/VS code/text to SQL LLM app along with quering SQL database/venv\Library\lib\tclstub86.lib'
